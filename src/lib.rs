...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting AIHub processing");
    
    let mut processor = AIHubProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = AIHubProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = AIHubProcessor::new(false);
